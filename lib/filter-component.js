define(['jquery'], function ($) {
    function transform() {
        ...
        formToTransform.hide();
        insertFilterButtonBefore(formToTransform);
        ...
        function insertFilterButtonBefore(formToTransform) {
            var filterButton = $('<button type="button" class="btn" aria-expanded="true">Ajouter un filtre</button>');

            filterButton.insertBefore(formToTransform);

            filterButton.on('click', function () {
                formToTransform.show();
            });
        ...
        function insertA11ySelectorBefore(hiddenDiv) {
            var a11ySelector = $('' +
                ...
                '  <input type="text" id="a11y-select-js" class="js-combobox" list="a11y-select-option-list" autocomplete="off">' +
