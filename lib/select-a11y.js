    ...
    function transform() {
        ...
        function transform($selectToTransform) {
            ...
            function insertA11ySelect() {
                ...
                var usageHelp = '. Utilisez la tabulation (ou la touche flèche du bas) pour naviguer dans la liste des suggestions';
                var $container = $('' +
                    '<div class="a11y-container">' +
                    '  <label for="a11y-' + selectId + '-js" class="sr-only">' + $label.text() + usageHelp + '</label>' +
