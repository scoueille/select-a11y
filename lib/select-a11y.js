define(['jquery'], function ($) {
    function transform() {
        ...
        function transform($selectToTransform) {
            ...
            $selectParent.hide();
            var $filterButton = insertFilterButtonBefore($a11ySelector, $selectParent.find('label'));
            ...
            function handleInput($a11ySelector, $hiddenSelect) {
                ...
                function appendListItem($option) {
                    var listItem = $('' +
                        ...
                        '    <button class="tag-item-supp" title="supprimer la selection" aria-labelledby="' + selectId + '-' + $option.data('id') + '" type="button">' +
                    ...
                    $listSelection.find('#' + selectId + '-' + $option.data('id') + ' button').on('click', onClick);
